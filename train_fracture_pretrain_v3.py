...
def train():
    args = Args()
    mlflow.start_run(run_name="focal_sampler_pretrain")
    ...
    train_loader = DataLoader(UnifiedFractureDataset(train_df, transform), batch_size=args.batch_size,
                              sampler=sampler, num_workers=args.num_workers)
    val_loader = DataLoader(UnifiedFractureDataset(val_df, transform), batch_size=args.batch_size,
    ...
    for epoch in range(args.num_epochs):
        ...
        for t in args.threshold_sweep:
            ...
            if val_f1 > best_f1:
                ...
                patience_counter = 0
                improved = True
                torch.save(model.state_dict(), "swinT_pretrained_fx_sampler_focal_best.pt")
