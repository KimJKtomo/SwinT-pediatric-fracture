# test_fracture_classifier_v1.py - Swin-T Binary Fracture Classification Evaluation
import os
import glob
import torch
import pandas as pd
...
def run_test(img_dir, model, device, threshold=0.5):
...
if __name__ == '__main__':
    ...
    weights_path = "/mnt/data/KimJG/SwinT/mediaiOA_swinT_cls-main_original/20250605_new/swinT_pretrained_fx_focal_best_0610.pt"
    output_csv = "test_results_fx.csv"
    threshold = 0.5
